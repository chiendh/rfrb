...
#include <fstream>
#include <iomanip>
#include <cstring> // Thêm để sử dụng memcpy và memset
...
private:
    ...
    /* New function to estimate RAID level
     */
    bool estimateRaidLevel(unsigned int raid1, unsigned int raid5, unsigned int misses, const std::vector<FileReader *> &inFiles);
...
public:
     ...
     * the necessary functions and classes.
     */
